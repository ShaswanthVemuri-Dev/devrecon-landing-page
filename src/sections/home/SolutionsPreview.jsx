...
const ServiceCard = ({ icon: Icon, title, desc, to, delay }) => (
  <motion.div 
  ...
  >
    ...
    <Link
      to={to}
      className="mt-auto inline-flex items-center gap-2 text-sm font-semibold tracking-wide text-black border-b border-black pb-1 w-fit hover:text-gray-600 hover:border-gray-600 transition-colors relative z-10"
    >
      Explore solution
  ...
  return (
    <section id="solutions-preview" className="py-20 md:py-32 px-6 max-w-7xl mx-auto relative">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <ServiceCard 
          icon={Cpu}
          title="AI Consulting and Applications"
          desc="For teams navigating AI or just starting. We design pragmatic AI systems, AI workflows, custom models, and applied automation."
          to="/solutions#ai"
          delay={0.1}
        />
        <ServiceCard 
          ...
          desc="From web platforms to internal tools. We build robust systems tailored to specific operational needs."
        ...
        <ServiceCard 
          ...
          desc="Software, electronics, IoT, physical systems, prototypes, and complex technology where code meets hardware."
