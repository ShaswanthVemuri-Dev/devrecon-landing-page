...
const Hero = () => {
  return (
    <section className="relative pt-24 md:pt-32 pb-20 md:pb-32 px-6 max-w-7xl mx-auto w-full min-h-[85vh] md:min-h-[90vh] flex flex-col justify-center overflow-hidden">
      <CircuitBackground />
