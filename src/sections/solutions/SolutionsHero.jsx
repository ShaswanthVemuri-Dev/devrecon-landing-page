          ...
          <div className="mt-11 flex flex-wrap gap-3">
            {solutions.map((solution, index) => (
              <a
                ...
                className="motion-pill motion-pill-light rounded-full border border-gray-200 bg-white/75 px-4 py-2.5 text-xs font-semibold tracking-wide text-gray-700 backdrop-blur-sm hover:border-black hover:bg-black hover:text-white sm:px-5 sm:py-3 sm:text-sm"
